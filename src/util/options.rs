...
const DEFAULT_PERF_EVENTS: PerfEventOptions = PerfEventOptions {
    events: &[
        ...
        (
            PerfEventKind::Hardware(PerfEventHardware::CPU_CYCLES),
            "PERF_COUNT_HW_CPU_CYCLES",
            0,
            -1,
        ),
        (
            PerfEventKind::Hardware(PerfEventHardware::INSTRUCTIONS),
            "PERF_COUNT_HW_INSTRUCTIONS",
            0,
            -1,
        ),
        // (PerfEventKind::Raw(0x002A), "L3D_CACHE_REFILL", 0, -1),
        // (PerfEventKind::Raw(0x002B), "L3D_CACHE_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0023), "STALL_FRONTEND", 0, -1),
        // (PerfEventKind::Raw(0x0001), "L1I_CACHE_REFILL", 0, -1),
        // (PerfEventKind::Raw(0x0014), "L1I_CACHE_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0002), "L1I_TLB_REFILL", 0, -1),
        // (PerfEventKind::Raw(0x0026), "L1I_TLB_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x002E), "L2I_TLB_REFILL", 0, -1),
        // (PerfEventKind::Raw(0x0030), "L2I_TLB_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0024), "STALL_BACKEND", 0, -1),
        // (PerfEventKind::Raw(0x4005), "STALL_BACKEND_MEM", 0, -1),
        // (PerfEventKind::Raw(0x0025), "L1D_TLB_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0005), "L1D_TLB_REFILL", 0, -1),
        // (PerfEventKind::Raw(0x002D), "L2D_TLB_REFILL", 0, -1),
        // (PerfEventKind::Raw(0x002F), "L2D_TLB_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0013), "MEM_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0019), "BUS_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0004), "L1D_CACHE_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0003), "L1D_CACHE_REFILL", 0, -1),
        // (PerfEventKind::Raw(0x0016), "L2D_CACHE_ACCESS", 0, -1),
        // (PerfEventKind::Raw(0x0017), "L2D_CACHE_REFILL", 0, -1),
        ...
        (
            PerfEventKind::Software(PerfEventSoftware::PAGE_FAULTS),
...
options! {
    ...
    /// The size of vmspace.
    vm_space_size:         usize                [env_var: true, command_line: true]  [always_valid] = 0x0,
